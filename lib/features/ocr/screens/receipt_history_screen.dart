...
class _ReceiptHistoryScreenState extends State<ReceiptHistoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final categoryFilters = <String>{
      for (final r in receipts)
        if (categoryById[r.categoryId] != null) categoryById[r.categoryId]!.name
    }.toList();
  ...
  Widget _header(BuildContext context, List<String> categoryFilters) => Container(
      ...
      Container(
        ...
        child: Row(
          children: [
            ...
            _stat('Total amount', 'RM ${totalAmount.toStringAsFixed(2)}',
  ...
  Widget _emptyState() => Center(
        child: Column(
          ...
          children: [
            ...
            const Text('Scan a receipt to see it here',
                style:
