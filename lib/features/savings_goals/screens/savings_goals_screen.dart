...
class _SavingsGoalsScreenState extends State<SavingsGoalsScreen> {
      ...
      body: provider.isLoading
          ...
          : ListView(
              ...
              children: [
                ...
                ...provider.goals.map((g) => _goalCard(context, g, fmt)),
  ...
  Widget _emptyState(String? error) => Center(
    child: Column(
      ...
      children: [
        ...
        Text(
          error ?? 'Tap + to create your first goal',
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text(
                'RM ${fmt.format(goal.currentAmount)}',
                style: const TextStyle(
              ...
              Text(
                'RM ${fmt.format(goal.targetAmount)}',
                style: const TextStyle(
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  labelText: 'Amount (RM)',
                  prefixText: 'RM ',
                  helperText: 'Max: RM ${fmt.format(goal.currentAmount)}',
                ),
                onChanged: (_) {
                  if (errorMsg != null) setSheet(() => errorMsg = null);
                },
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: remaining == 0
                          ...
                          : AppColors.budgetYellow.withValues(alpha: 0.1),
                      borderRadius: BorderRadius.circular(8),
                    ),
                    child: Row(
                      children: [
                          ...
                          ? () async {
                              ...
                              for (final g in goals) {
                                final amt =
                                    ...
                                    0;
                                if (amt <= 0) continue;
                                final latest = sgProvider.goals.firstWhere(
                                  (x) => x.id == g.id,
                                  orElse: () => g,
                                );
  ...
  void _showAutoTransferSheet(BuildContext context, SavingsGoalModel goal) {
    ...
    WalletModel selectedWallet = wallets.firstWhere(
      (w) => w.id == goal.autoTransferSourceWalletId,
                  ...
                  onPressed: () async {
                    ...
                    await context.read<SavingsGoalProvider>().update(
                      goal.copyWith(
                        ...
                        autoTransferSourceWalletId: enabled
                            ? selectedWallet.id
                            : null,
                        autoTransferDayOfMonth: enabled ? dayOfMonth : null,
                      ),
                    );
                    if (ctx.mounted) Navigator.pop(ctx);
                  },
  ...
  void _showGoalSheet(BuildContext context, {SavingsGoalModel? goal}) {
    ...
    final walletLabelCtrl = TextEditingController(
      text: goal?.linkedWalletLabel ?? '',
    );
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setSheetState) => Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                goal == null ? 'New Savings Goal' : 'Edit Goal',
                style: const TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.bold,
                ),
                    ...
                    if (goal == null) {
                      await provider.add(
                        SavingsGoalModel(
                          ...
                          currentAmount: 0,
                          deadline: deadline,
                          linkedWalletLabel: label.isNotEmpty ? label : null,
